...
## Removed Cron - Fully Dockerized

Replaced external cron job with IBC's built-in `ColdRestartTime` setting.

**Before:**
- Cron on EC2 host: `0 4 * * 0 sunday_restart.sh`
- Manual deployment step, not in git

**After:**
- docker-compose.yml: `TWS_COLD_RESTART: "04:00 AM"`
- Everything in git, fully portable

**Benefits:**
- Deploy anywhere with just `docker-compose up`
- No manual cron setup needed
- Ready for Helm/Kubernetes in future
